...
--
-- Värd: 127.0.0.1
-- Tid vid skapande: 02 jun 2019 kl 21:04
...
--
ALTER TABLE `posts`
  MODIFY `post_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT för tabell `subs`
--
ALTER TABLE `subs`
  MODIFY `sub_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
